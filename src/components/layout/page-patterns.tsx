...
export function PageFrame({ children, className, maxWidth = "default" }: PageFrameProps) {
  return (
    <div className="px-4 py-4 pb-28 sm:px-6 sm:py-6 lg:px-8 lg:py-8 lg:pb-10">
      <div className={cn("mx-auto space-y-4 sm:space-y-7", maxWidthClass[maxWidth], className)}>
        {children}
      </div>
    </div>
  );
